...
What does it take to raise course completion from 52% to 78% across 12,000 learners? The companion case study follows **LearnPath** — an adaptive Python programming platform — as they deploy IRT placement testing (4 minutes vs. 3 weeks of fixed curriculum), Bayesian Knowledge Tracing that detects declining mastery after 2 failures, misconception-targeted feedback that tells students _why_ their break statement is wrong, and SM-2 spaced repetition that prevents skill decay over 6 weeks.
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------- | -------------------------------- |
| [ch15_education_and_knowledge_agents\_\_RUN_NO_KEY_SIMULATION.ipynb](ch15_education_and_knowledge_agents__RUN_NO_KEY_SIMULATION.ipynb)                       | Simulation       | No API key — MockLLM responses   |
| [ch15_education_and_knowledge_agents\_\_RUN_OPENAI_GPT4o.ipynb](ch15_education_and_knowledge_agents__RUN_OPENAI_GPT4o.ipynb)                                 | OpenAI GPT-4o    | Live LLM via `OPENAI_API_KEY`    |
| [ch15_education_and_knowledge_agents\_\_RUN_CLAUDE_Sonnet4.ipynb](ch15_education_and_knowledge_agents__RUN_CLAUDE_Sonnet4.ipynb)                             | Claude Sonnet 4  | Live LLM via `ANTHROPIC_API_KEY` |
| [ch15_education_and_knowledge_agents\_\_RUN_GEMINI_Flash25.ipynb](ch15_education_and_knowledge_agents__RUN_GEMINI_Flash25.ipynb)                             | Gemini Flash 2.5 | Live LLM via `GOOGLE_API_KEY`    |
| [ch15_education_and_knowledge_agents\_\_RUN_LOCAL_OLLAMA_DeepSeek_V2_16B.ipynb](ch15_education_and_knowledge_agents__RUN_LOCAL_OLLAMA_DeepSeek_V2_16B.ipynb) | Local Ollama     | DeepSeek V2 16B — no API key     |
